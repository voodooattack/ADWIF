...
IF (WIN32)
  ...
  FIND_LIBRARY( FREEIMAGEPLUS_LIBRARY
    ...
    PATHS
    ${DEP_DIR}/FreeImage
    DOC "The FreeImage C++ wrapper library")
ELSE (WIN32)
  FIND_PATH( FREEIMAGE_INCLUDE_PATH FreeImage.h
    /usr/include
    /usr/local/include
...
IF (FREEIMAGE_INCLUDE_PATH AND FREEIMAGE_LIBRARY AND FREEIMAGEPLUS_LIBRARY)
  SET( FREEIMAGE_FOUND TRUE CACHE BOOL "Set to TRUE if FreeImage is found, FALSE otherwise")
ELSE (FREEIMAGE_INCLUDE_PATH AND FREEIMAGE_LIBRARY AND FREEIMAGEPLUS_LIBRARY)
  SET( FREEIMAGE_FOUND FALSE CACHE BOOL "Set to TRUE if FreeImage is found, FALSE otherwise")
ENDIF (FREEIMAGE_INCLUDE_PATH AND FREEIMAGE_LIBRARY AND FREEIMAGEPLUS_LIBRARY)
